...
// --- MUDANÇA: Atribuídos pinos EXCLUSIVOS para o motor direito ---
#define INPUT_RIGHT_1       GPIO_NUM_23
#define INPUT_RIGHT_2       GPIO_NUM_22

#define INPUT_LEFT_1        GPIO_NUM_25
#define INPUT_LEFT_2        GPIO_NUM_33

#define PWM_GPIO_LEFT       GPIO_NUM_26
#define PWM_GPIO_RIGHT      GPIO_NUM_19 // MUDANÇA
